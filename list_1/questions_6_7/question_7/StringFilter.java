...
/**
 * Gets the strings puts in the {@link Channel}, and adds the alpha string into
 * filtered {@link Channel}.
 *
 */
public class StringFilter implements Runnable {
  ...
  /**
   * Verifies and returns {@code true} if is contains Number, {@code false}
   * otherwise.
   *
  ...
  public void run() {
    ...
    // After filtered all strings in producerChannel, It's necessary close the
